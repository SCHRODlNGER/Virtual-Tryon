...
def main(DATA_DIR = "./datasets_segmentation/CIHP", LIST_PATH = "./datasets_segmentation/CIHP/list/val.txt", DATA_ID_LIST = "./datasets_segmentation/CIHP/list/val_id.txt", RESTORE_FROM = "./semanticParsingCheckpoint/CIHP_pgn", parsing_dir = './output/cihp_parsing_maps'):
